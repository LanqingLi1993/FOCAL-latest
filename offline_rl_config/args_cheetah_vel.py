...
def get_args(rest_args):
    ...
    parser.add_argument('--vf-lr', type=float, default=3e-4, help='learning rate for v network')
    parser.add_argument('--clip-grad-value', type=float, default=None, help='clip gradients')
    parser.add_argument('--entropy-alpha', type=float, default=0, help='Entropy coefficient')
